...
object StoreStrings {
    ...
    const val REPORT_PREVIEW_TITLE_AR = "معاينة التقرير"
    const val REPORT_PREVIEW_TITLE_EN = "Report Preview"
...
object SampleData {
    ...
    val sampleTransactions: List<TransactionItem> = listOf(
        TransactionItem("tx1", "شراء مواد غذائية", "أحمد الشمري", "شراء آجل", 250.0, true, "2026-09-05", "منذ 15 دقيقة", "فاتورة بقالة"),
        TransactionItem("tx2", "تسديد دفعة", "خالد العتيبي", "تسديد", 100.0, false, "2026-09-05", "منذ ساعة", "سداد نقدي", SettlementType.PARTIAL),
        TransactionItem("tx3", "شراء كاش", "عميل عام", "شراء كاش", 85.0, false, "2026-09-05", "منذ ساعتين", "دفع فوري"),
        TransactionItem("tx4", "شراء مواد استهلاكية", "محمد الغامدي", "شراء آجل", 450.0, true, "2026-09-04", "أمس", "مشتريات منزلية"),
        TransactionItem("tx5", "تسديد حساب", "أحمد الشمري", "تسديد", 300.0, false, "2026-09-04", "أمس", "تحويل بنكي", SettlementType.FULL),
        TransactionItem("tx6", "شراء آجل", "عبدالله الشهري", "شراء آجل", 310.0, true, "2026-09-03", "منذ يومين", "أدوات ومستلزمات"),
        TransactionItem("tx7", "تسديد نقدي", "سعيد القحطاني", "تسديد", 500.0, false, "2026-09-01", "منذ 4 أيام", "تسوية كاملة", SettlementType.FULL)
    )
